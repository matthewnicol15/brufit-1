{
  ...
  Flat.SetUp().LoadVariable("KpKmCosTh[-1,1]");
  Flat.SetUp().LoadVariable("KpKmPhi[-3.14159,3.14159]");
  Flat.SetUp().LoadVariable("KpKmPolPhi[-3.14159,3.14159]");
  Flat.SetUp().LoadVariable("KpKmPol[0.7,0.8]");


  Flat.SetUp().LoadFunctionVar("RooConstVar::Val(1)");
  Flat.SetUp().FactoryPDF("RooComponentsPDF::Flat(1,{KpKmCosTh,KpKmPhi,KpKmPolPhi,KpKmPol},=Val)");
  ...
  Generator.SetUp().LoadVariable("KpKmCosTh[-1,1]");
  Generator.SetUp().LoadVariable("KpKmPhi[-3.14159,3.14159]");
  Generator.SetUp().LoadVariable("KpKmPolPhi[-3.14159,3.14159]");
  Generator.SetUp().LoadVariable("KpKmPol[0.7,0.8]");

  //use parser to expand spherical harmonics with  0<L<4 0<M<L
  //and create all constants
  //PolarisedSphHarmonicMoments(TString name,TString cth,TString KpKmPhi,TString KpKmPhiPol,TString Pol,Int_t Lmax,Int_t Mmin,Int_t Mmax)
  ...
  //Y_L_M are spherical harmonic functions depending on KpKmCosTh and KpKmPhi
  ...
  //COS2KpKmPhi => formula defined in  PolarisedSphHarmonicMoments
  //ReY_L_M(KpKmCosTh,KpKmPhi,Y_L_M)} => real part of Y^M_L a function of KpKmCosTh, KpKmPhi
